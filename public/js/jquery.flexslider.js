...
(function ($) {
  ...
  $.flexslider.defaults = {
    ...
    pauseOnHover: false, //Boolean: Pause the slideshow when hovering over slider, then chart when no longer hovering
    pauseInvisible: true, //{NEW} Boolean: Pause the slideshow when tab is invisible, chart when visible. Provides better UX, lower CPU usage.
